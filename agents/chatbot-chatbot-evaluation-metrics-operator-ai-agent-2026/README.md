# Chatbot Chatbot Evaluation Metrics Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-chatbot-evaluation-metrics-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-chatbot-evaluation-metrics-operator-ai-agent-2026.md`)
