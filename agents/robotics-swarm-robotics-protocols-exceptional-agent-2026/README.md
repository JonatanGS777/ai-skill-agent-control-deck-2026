# Robotics Swarm Robotics Protocols Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-swarm-robotics-protocols-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-swarm-robotics-protocols-exceptional-agent-2026.md`)
