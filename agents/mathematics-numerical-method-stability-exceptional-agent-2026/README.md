# Mathematics Numerical Method Stability Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-numerical-method-stability-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-numerical-method-stability-exceptional-agent-2026.md`)
