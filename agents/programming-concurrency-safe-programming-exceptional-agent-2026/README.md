# Programming Concurrency Safe Programming Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-concurrency-safe-programming-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-concurrency-safe-programming-exceptional-agent-2026.md`)
