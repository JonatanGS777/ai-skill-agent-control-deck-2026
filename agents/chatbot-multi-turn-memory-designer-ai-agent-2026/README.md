# Chatbot Multi Turn Memory Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-multi-turn-memory-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-multi-turn-memory-designer-ai-agent-2026.md`)
