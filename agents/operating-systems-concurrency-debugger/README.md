# Operating Systems Concurrency Debugger

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/operating-systems-concurrency-debugger.md`)
- Codex (`~/.codex/agents/operating-systems-concurrency-debugger.md`)
