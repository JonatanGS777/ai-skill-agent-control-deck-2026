# Chatbot Retrieval Augmented Chat Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-retrieval-augmented-chat-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-retrieval-augmented-chat-designer-ai-agent-2026.md`)
