# Robotics State Estimation And Filtering Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-state-estimation-and-filtering-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-state-estimation-and-filtering-exceptional-agent-2026.md`)
