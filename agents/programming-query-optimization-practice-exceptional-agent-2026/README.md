# Programming Query Optimization Practice Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-query-optimization-practice-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-query-optimization-practice-exceptional-agent-2026.md`)
