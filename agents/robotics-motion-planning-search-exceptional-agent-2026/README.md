# Robotics Motion Planning Search Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-motion-planning-search-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-motion-planning-search-exceptional-agent-2026.md`)
