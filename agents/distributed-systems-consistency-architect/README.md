...
- Claude Code (`~/.claude/agents/distributed-systems-consistency-architect.md`)
- Codex (`~/.codex/agents/distributed-systems-consistency-architect.md`)

## Purpose
Diseña sistemas distribuidos resilientes con estrategias de consistencia, particionado y tolerancia a fallos.
