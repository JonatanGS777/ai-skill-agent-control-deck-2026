# Ai Energy Demand Forecasting Strategist Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-energy-demand-forecasting-strategist-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-energy-demand-forecasting-strategist-ai-agent-2026.md`)
