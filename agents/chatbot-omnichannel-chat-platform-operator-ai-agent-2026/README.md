# Chatbot Omnichannel Chat Platform Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-omnichannel-chat-platform-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-omnichannel-chat-platform-operator-ai-agent-2026.md`)
