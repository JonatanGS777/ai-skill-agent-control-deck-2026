# Chatbot Support Chatbot Operations Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-support-chatbot-operations-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-support-chatbot-operations-designer-ai-agent-2026.md`)
