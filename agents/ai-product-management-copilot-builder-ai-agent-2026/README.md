# Ai Product Management Copilot Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-product-management-copilot-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-product-management-copilot-builder-ai-agent-2026.md`)
