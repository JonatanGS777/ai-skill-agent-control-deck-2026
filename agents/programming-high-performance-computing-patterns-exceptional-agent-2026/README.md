# Programming High Performance Computing Patterns Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-high-performance-computing-patterns-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-high-performance-computing-patterns-exceptional-agent-2026.md`)
