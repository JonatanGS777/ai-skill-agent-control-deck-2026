# Chatbot Multilingual Chatbot Systems Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-multilingual-chatbot-systems-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-multilingual-chatbot-systems-operator-ai-agent-2026.md`)
