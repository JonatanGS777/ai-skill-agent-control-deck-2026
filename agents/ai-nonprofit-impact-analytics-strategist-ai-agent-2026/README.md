# Ai Nonprofit Impact Analytics Strategist Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-nonprofit-impact-analytics-strategist-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-nonprofit-impact-analytics-strategist-ai-agent-2026.md`)
