# Ai Hospitality Service Assistants Auditor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-hospitality-service-assistants-auditor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-hospitality-service-assistants-auditor-ai-agent-2026.md`)
