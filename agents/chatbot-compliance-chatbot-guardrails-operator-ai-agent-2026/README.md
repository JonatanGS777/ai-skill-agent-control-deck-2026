# Chatbot Compliance Chatbot Guardrails Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-compliance-chatbot-guardrails-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-compliance-chatbot-guardrails-operator-ai-agent-2026.md`)
