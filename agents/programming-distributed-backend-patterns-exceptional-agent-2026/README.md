# Programming Distributed Backend Patterns Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-distributed-backend-patterns-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-distributed-backend-patterns-exceptional-agent-2026.md`)
