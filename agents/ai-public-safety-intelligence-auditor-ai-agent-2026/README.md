# Ai Public Safety Intelligence Auditor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-public-safety-intelligence-auditor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-public-safety-intelligence-auditor-ai-agent-2026.md`)
