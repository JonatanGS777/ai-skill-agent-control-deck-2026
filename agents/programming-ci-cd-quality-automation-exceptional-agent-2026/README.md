# Programming Ci Cd Quality Automation Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-ci-cd-quality-automation-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-ci-cd-quality-automation-exceptional-agent-2026.md`)
