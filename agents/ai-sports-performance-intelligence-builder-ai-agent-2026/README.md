# Ai Sports Performance Intelligence Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-sports-performance-intelligence-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-sports-performance-intelligence-builder-ai-agent-2026.md`)
