# Mathematics Axiomatic Set Reasoning Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-axiomatic-set-reasoning-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-axiomatic-set-reasoning-exceptional-agent-2026.md`)
