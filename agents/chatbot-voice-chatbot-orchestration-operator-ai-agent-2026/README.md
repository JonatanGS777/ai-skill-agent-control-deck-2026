# Chatbot Voice Chatbot Orchestration Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-voice-chatbot-orchestration-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-voice-chatbot-orchestration-operator-ai-agent-2026.md`)
