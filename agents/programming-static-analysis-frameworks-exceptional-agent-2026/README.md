# Programming Static Analysis Frameworks Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-static-analysis-frameworks-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-static-analysis-frameworks-exceptional-agent-2026.md`)
