# Mathematics Formal Proof Strategy Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-formal-proof-strategy-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-formal-proof-strategy-exceptional-agent-2026.md`)
