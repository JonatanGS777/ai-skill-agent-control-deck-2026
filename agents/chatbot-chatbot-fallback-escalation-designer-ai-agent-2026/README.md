# Chatbot Chatbot Fallback Escalation Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-chatbot-fallback-escalation-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-chatbot-fallback-escalation-designer-ai-agent-2026.md`)
