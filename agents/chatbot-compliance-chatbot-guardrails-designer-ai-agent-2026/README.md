# Chatbot Compliance Chatbot Guardrails Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-compliance-chatbot-guardrails-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-compliance-chatbot-guardrails-designer-ai-agent-2026.md`)
