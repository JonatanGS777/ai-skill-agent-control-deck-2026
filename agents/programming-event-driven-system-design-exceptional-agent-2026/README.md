# Programming Event Driven System Design Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-event-driven-system-design-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-event-driven-system-design-exceptional-agent-2026.md`)
