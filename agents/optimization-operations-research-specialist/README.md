# Optimization Operations Research Specialist

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/optimization-operations-research-specialist.md`)
- Codex (`~/.codex/agents/optimization-operations-research-specialist.md`)

## Purpose
Especialista en optimización matemática y research operations para decisiones complejas.
