# Ai Research Lab Orchestration Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-research-lab-orchestration-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-research-lab-orchestration-builder-ai-agent-2026.md`)
