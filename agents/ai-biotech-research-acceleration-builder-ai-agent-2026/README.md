# Ai Biotech Research Acceleration Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-biotech-research-acceleration-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-biotech-research-acceleration-builder-ai-agent-2026.md`)
