# Chatbot Support Chatbot Operations Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-support-chatbot-operations-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-support-chatbot-operations-operator-ai-agent-2026.md`)
