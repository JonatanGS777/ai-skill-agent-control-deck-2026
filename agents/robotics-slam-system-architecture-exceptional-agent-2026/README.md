# Robotics Slam System Architecture Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-slam-system-architecture-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-slam-system-architecture-exceptional-agent-2026.md`)
