...
- Claude Code (`~/.claude/agents/quantum-computing-algorithm-researcher.md`)
- Codex (`~/.codex/agents/quantum-computing-algorithm-researcher.md`)

## Purpose
Explora algoritmos cuánticos, complejidad y estrategias híbridas clásicas-cuánticas.
