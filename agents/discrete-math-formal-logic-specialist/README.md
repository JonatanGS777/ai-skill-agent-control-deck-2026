# Discrete Math Formal Logic Specialist

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/discrete-math-formal-logic-specialist.md`)
- Codex (`~/.codex/agents/discrete-math-formal-logic-specialist.md`)

## Purpose
Especialista en lógica formal, razonamiento discreto y validación de propiedades críticas.
