# Robotics Sensor Fusion Pipelines Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-sensor-fusion-pipelines-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-sensor-fusion-pipelines-exceptional-agent-2026.md`)
