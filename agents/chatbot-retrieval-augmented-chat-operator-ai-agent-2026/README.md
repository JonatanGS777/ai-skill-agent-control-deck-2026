# Chatbot Retrieval Augmented Chat Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-retrieval-augmented-chat-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-retrieval-augmented-chat-operator-ai-agent-2026.md`)
