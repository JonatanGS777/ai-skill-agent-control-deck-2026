# Chatbot Prompt Routing Strategies Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-prompt-routing-strategies-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-prompt-routing-strategies-designer-ai-agent-2026.md`)
