# Mathematics Linear Algebraic Transforms Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-linear-algebraic-transforms-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-linear-algebraic-transforms-exceptional-agent-2026.md`)
