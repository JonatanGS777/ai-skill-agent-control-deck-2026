# Programming Algorithm Design Architectures Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-algorithm-design-architectures-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-algorithm-design-architectures-exceptional-agent-2026.md`)
