# Mathematics Eigen Structure Analysis Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-eigen-structure-analysis-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-eigen-structure-analysis-exceptional-agent-2026.md`)
