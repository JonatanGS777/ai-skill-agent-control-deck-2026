# Mathematics Number Theory Algorithms Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-number-theory-algorithms-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-number-theory-algorithms-exceptional-agent-2026.md`)
