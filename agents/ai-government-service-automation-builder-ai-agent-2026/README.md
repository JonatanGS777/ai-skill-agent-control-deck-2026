# Ai Government Service Automation Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-government-service-automation-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-government-service-automation-builder-ai-agent-2026.md`)
