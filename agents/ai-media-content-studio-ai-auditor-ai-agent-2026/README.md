# Ai Media Content Studio Ai Auditor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-media-content-studio-ai-auditor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-media-content-studio-ai-auditor-ai-agent-2026.md`)
