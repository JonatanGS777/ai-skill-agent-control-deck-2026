...
- Claude Code (`~/.claude/agents/computer-vision-pipeline-specialist.md`)
- Codex (`~/.codex/agents/computer-vision-pipeline-specialist.md`)

## Purpose
Especialista en pipelines de visión computacional, pre/post-procesamiento y evaluación reproducible.
