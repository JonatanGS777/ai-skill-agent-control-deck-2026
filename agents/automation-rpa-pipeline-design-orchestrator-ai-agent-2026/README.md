# Automation Rpa Pipeline Design Orchestrator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/automation-rpa-pipeline-design-orchestrator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/automation-rpa-pipeline-design-orchestrator-ai-agent-2026.md`)
