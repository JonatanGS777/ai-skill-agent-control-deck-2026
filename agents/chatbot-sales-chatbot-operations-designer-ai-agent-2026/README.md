# Chatbot Sales Chatbot Operations Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-sales-chatbot-operations-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-sales-chatbot-operations-designer-ai-agent-2026.md`)
