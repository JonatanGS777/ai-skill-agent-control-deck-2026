# Stochastic Simulation Monte Carlo Engineer

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/stochastic-simulation-monte-carlo-engineer.md`)
- Codex (`~/.codex/agents/stochastic-simulation-monte-carlo-engineer.md`)
