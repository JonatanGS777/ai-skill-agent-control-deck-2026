...
- Claude Code (`~/.claude/agents/mlops-model-serving-engineer.md`)
- Codex (`~/.codex/agents/mlops-model-serving-engineer.md`)

## Purpose
Construye pipelines MLOps para entrenamiento, serving y monitoreo de modelos en producción.
