# Data Structures Performance Engineer

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/data-structures-performance-engineer.md`)
- Codex (`~/.codex/agents/data-structures-performance-engineer.md`)
