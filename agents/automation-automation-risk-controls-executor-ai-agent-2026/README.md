# Automation Automation Risk Controls Executor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/automation-automation-risk-controls-executor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/automation-automation-risk-controls-executor-ai-agent-2026.md`)
