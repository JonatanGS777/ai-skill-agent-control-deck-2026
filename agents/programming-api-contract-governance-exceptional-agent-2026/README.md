# Programming Api Contract Governance Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-api-contract-governance-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-api-contract-governance-exceptional-agent-2026.md`)
