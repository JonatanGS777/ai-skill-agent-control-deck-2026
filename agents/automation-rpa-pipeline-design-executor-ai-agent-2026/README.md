# Automation Rpa Pipeline Design Executor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/automation-rpa-pipeline-design-executor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/automation-rpa-pipeline-design-executor-ai-agent-2026.md`)
