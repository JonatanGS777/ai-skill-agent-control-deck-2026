# Programming Memory Model Practice Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-memory-model-practice-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-memory-model-practice-exceptional-agent-2026.md`)
