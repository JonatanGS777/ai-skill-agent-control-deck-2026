# Mathematics Bayesian Inference Systems Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-bayesian-inference-systems-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-bayesian-inference-systems-exceptional-agent-2026.md`)
