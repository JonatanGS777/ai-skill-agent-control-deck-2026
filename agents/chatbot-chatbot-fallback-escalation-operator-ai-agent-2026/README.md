# Chatbot Chatbot Fallback Escalation Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-chatbot-fallback-escalation-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-chatbot-fallback-escalation-operator-ai-agent-2026.md`)
