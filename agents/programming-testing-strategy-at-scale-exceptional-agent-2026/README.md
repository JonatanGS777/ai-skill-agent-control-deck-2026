# Programming Testing Strategy At Scale Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-testing-strategy-at-scale-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-testing-strategy-at-scale-exceptional-agent-2026.md`)
