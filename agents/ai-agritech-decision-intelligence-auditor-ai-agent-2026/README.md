# Ai Agritech Decision Intelligence Auditor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-agritech-decision-intelligence-auditor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-agritech-decision-intelligence-auditor-ai-agent-2026.md`)
