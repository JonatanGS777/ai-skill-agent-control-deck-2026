# Robotics Humanoid Motion Intelligence Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-humanoid-motion-intelligence-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-humanoid-motion-intelligence-exceptional-agent-2026.md`)
