# Algorithmic Complexity Scientist

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/algorithmic-complexity-scientist.md`)
- Codex (`~/.codex/agents/algorithmic-complexity-scientist.md`)

## Purpose
Especialista en diseño de algoritmos, análisis de complejidad temporal/espacial y decisiones de tradeoff computacional.
