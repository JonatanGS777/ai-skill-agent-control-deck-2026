# Robotics Multi Robot Coordination Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-multi-robot-coordination-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-multi-robot-coordination-exceptional-agent-2026.md`)
