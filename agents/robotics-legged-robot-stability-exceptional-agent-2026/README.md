# Robotics Legged Robot Stability Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-legged-robot-stability-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-legged-robot-stability-exceptional-agent-2026.md`)
