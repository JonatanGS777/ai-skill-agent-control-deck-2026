# Mathematics Convex Optimization Toolkit Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-convex-optimization-toolkit-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-convex-optimization-toolkit-exceptional-agent-2026.md`)
