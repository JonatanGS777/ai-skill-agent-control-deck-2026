# Chatbot Sentiment Aware Dialog Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-sentiment-aware-dialog-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-sentiment-aware-dialog-operator-ai-agent-2026.md`)
