# Programming Observability Driven Debugging Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-observability-driven-debugging-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-observability-driven-debugging-exceptional-agent-2026.md`)
