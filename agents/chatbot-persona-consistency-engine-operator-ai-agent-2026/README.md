# Chatbot Persona Consistency Engine Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-persona-consistency-engine-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-persona-consistency-engine-operator-ai-agent-2026.md`)
