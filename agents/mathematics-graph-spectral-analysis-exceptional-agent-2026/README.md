# Mathematics Graph Spectral Analysis Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-graph-spectral-analysis-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-graph-spectral-analysis-exceptional-agent-2026.md`)
