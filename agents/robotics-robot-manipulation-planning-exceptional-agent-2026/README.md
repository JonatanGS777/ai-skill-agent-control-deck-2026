# Robotics Robot Manipulation Planning Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-robot-manipulation-planning-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-robot-manipulation-planning-exceptional-agent-2026.md`)
