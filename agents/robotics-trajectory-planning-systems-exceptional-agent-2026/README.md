# Robotics Trajectory Planning Systems Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-trajectory-planning-systems-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-trajectory-planning-systems-exceptional-agent-2026.md`)
