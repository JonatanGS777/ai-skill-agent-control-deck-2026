# Programming Infrastructure As Code Patterns Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-infrastructure-as-code-patterns-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-infrastructure-as-code-patterns-exceptional-agent-2026.md`)
