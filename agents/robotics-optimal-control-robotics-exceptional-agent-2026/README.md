# Robotics Optimal Control Robotics Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-optimal-control-robotics-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-optimal-control-robotics-exceptional-agent-2026.md`)
