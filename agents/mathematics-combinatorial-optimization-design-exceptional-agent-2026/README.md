# Mathematics Combinatorial Optimization Design Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-combinatorial-optimization-design-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-combinatorial-optimization-design-exceptional-agent-2026.md`)
