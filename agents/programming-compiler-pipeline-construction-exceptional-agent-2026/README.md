# Programming Compiler Pipeline Construction Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-compiler-pipeline-construction-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-compiler-pipeline-construction-exceptional-agent-2026.md`)
