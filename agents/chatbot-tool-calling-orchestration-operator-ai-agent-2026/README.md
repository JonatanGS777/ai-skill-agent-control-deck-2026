# Chatbot Tool Calling Orchestration Operator Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-tool-calling-orchestration-operator-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-tool-calling-orchestration-operator-ai-agent-2026.md`)
