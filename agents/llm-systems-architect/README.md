...
- Claude Code (`~/.claude/agents/llm-systems-architect.md`)
- Codex (`~/.codex/agents/llm-systems-architect.md`)

## Purpose
Diseña sistemas basados en LLM con pipelines robustos, prompts auditables y control de costos/calidad.
