# Computational Geometry Visualization Engineer

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/computational-geometry-visualization-engineer.md`)
- Codex (`~/.codex/agents/computational-geometry-visualization-engineer.md`)

## Purpose
Diseña algoritmos geométricos y visualizaciones de alta claridad para sistemas técnicos.
