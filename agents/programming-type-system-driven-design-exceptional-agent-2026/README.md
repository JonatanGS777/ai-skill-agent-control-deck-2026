# Programming Type System Driven Design Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-type-system-driven-design-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-type-system-driven-design-exceptional-agent-2026.md`)
