# Chatbot Sentiment Aware Dialog Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-sentiment-aware-dialog-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-sentiment-aware-dialog-designer-ai-agent-2026.md`)
