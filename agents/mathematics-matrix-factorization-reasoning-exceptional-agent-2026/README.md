# Mathematics Matrix Factorization Reasoning Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-matrix-factorization-reasoning-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-matrix-factorization-reasoning-exceptional-agent-2026.md`)
