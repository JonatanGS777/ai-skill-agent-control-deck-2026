# Robotics Grasp Synthesis Methods Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-grasp-synthesis-methods-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-grasp-synthesis-methods-exceptional-agent-2026.md`)
