# Ai Travel Planning Assistants Builder Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-travel-planning-assistants-builder-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-travel-planning-assistants-builder-ai-agent-2026.md`)
