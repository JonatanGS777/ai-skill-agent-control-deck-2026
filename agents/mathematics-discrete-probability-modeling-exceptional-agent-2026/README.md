# Mathematics Discrete Probability Modeling Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/mathematics-discrete-probability-modeling-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/mathematics-discrete-probability-modeling-exceptional-agent-2026.md`)
