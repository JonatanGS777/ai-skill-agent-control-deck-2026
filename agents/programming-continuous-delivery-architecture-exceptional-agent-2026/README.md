# Programming Continuous Delivery Architecture Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-continuous-delivery-architecture-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-continuous-delivery-architecture-exceptional-agent-2026.md`)
