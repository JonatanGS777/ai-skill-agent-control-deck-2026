# Programming Authentication Authorization Flows Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/programming-authentication-authorization-flows-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/programming-authentication-authorization-flows-exceptional-agent-2026.md`)
