# Ai Insurance Claims Automation Auditor Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/ai-insurance-claims-automation-auditor-ai-agent-2026.md`)
- Codex (`~/.codex/agents/ai-insurance-claims-automation-auditor-ai-agent-2026.md`)
