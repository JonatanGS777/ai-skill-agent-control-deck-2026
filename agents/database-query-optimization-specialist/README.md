...
- Claude Code (`~/.claude/agents/database-query-optimization-specialist.md`)
- Codex (`~/.codex/agents/database-query-optimization-specialist.md`)

## Purpose
Optimiza modelos de datos, índices y consultas complejas para sistemas transaccionales y analíticos.
