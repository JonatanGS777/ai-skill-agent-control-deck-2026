# Chatbot Omnichannel Chat Platform Designer Ai Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/chatbot-omnichannel-chat-platform-designer-ai-agent-2026.md`)
- Codex (`~/.codex/agents/chatbot-omnichannel-chat-platform-designer-ai-agent-2026.md`)
