# Robotics Visual Slam Engineering Exceptional Agent 2026

This folder contains a universal agent compatible with:

- Claude Code (`~/.claude/agents/robotics-visual-slam-engineering-exceptional-agent-2026.md`)
- Codex (`~/.codex/agents/robotics-visual-slam-engineering-exceptional-agent-2026.md`)
