...
Repositorio premium para construir, medir y escalar **skills** y **agentes** de IA con base lógica sólida.

## Public Launch Snapshot

- 203 skills locales especializadas (lógica, frontend, full stack, IA aplicada).
- 196 agentes listos para orquestación avanzada.
- Benchmark oficial con score por `logic`, `clarity`, `security`, `utility`.
- Regression checks + cobertura de casos reales + ranking de calidad.
- Dashboard y portal visual modernos listos para presentación pública.
...
- Portal de documentación: `docs/portal/index.html`
- Dashboard de calidad: `catalog/quality-dashboard.html`
- Social preview (GitHub): `docs/branding/social-preview.svg`

## Governance & CI

- Quality gate CI: `.github/workflows/repository-quality.yml`
- Release bundle CI: `.github/workflows/release-bundle.yml`
