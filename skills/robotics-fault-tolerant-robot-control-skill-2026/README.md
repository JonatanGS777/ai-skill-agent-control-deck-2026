# Robotics Fault Tolerant Robot Control Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-fault-tolerant-robot-control-skill-2026`)
- Codex (`~/.codex/skills/robotics-fault-tolerant-robot-control-skill-2026`)
