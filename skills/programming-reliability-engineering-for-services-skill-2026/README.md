...
- Claude Code (`~/.claude/skills/programming-reliability-engineering-for-services-skill-2026`)
- Codex (`~/.codex/skills/programming-reliability-engineering-for-services-skill-2026`)
