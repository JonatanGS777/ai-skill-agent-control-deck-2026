# Ai Domain Media Content Studio Ai Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/ai-domain-media-content-studio-ai-skill-2026`)
- Codex (`~/.codex/skills/ai-domain-media-content-studio-ai-skill-2026`)
