# Programming Domain Driven Design Workflows Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-domain-driven-design-workflows-skill-2026`)
- Codex (`~/.codex/skills/programming-domain-driven-design-workflows-skill-2026`)
