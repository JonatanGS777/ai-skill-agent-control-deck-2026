# Robotics Embedded Ai Robotics Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-embedded-ai-robotics-skill-2026`)
- Codex (`~/.codex/skills/robotics-embedded-ai-robotics-skill-2026`)
