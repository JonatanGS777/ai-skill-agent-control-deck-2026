# Robotics Ethical Robotic Deployment Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-ethical-robotic-deployment-skill-2026`)
- Codex (`~/.codex/skills/robotics-ethical-robotic-deployment-skill-2026`)
