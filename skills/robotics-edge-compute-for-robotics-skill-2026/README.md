# Robotics Edge Compute For Robotics Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-edge-compute-for-robotics-skill-2026`)
- Codex (`~/.codex/skills/robotics-edge-compute-for-robotics-skill-2026`)
