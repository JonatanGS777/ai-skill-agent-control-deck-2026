# Robotics Real Time Robotic Systems Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-real-time-robotic-systems-skill-2026`)
- Codex (`~/.codex/skills/robotics-real-time-robotic-systems-skill-2026`)
