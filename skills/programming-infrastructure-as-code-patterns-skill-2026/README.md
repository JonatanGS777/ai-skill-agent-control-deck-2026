...
- Claude Code (`~/.claude/skills/programming-infrastructure-as-code-patterns-skill-2026`)
- Codex (`~/.codex/skills/programming-infrastructure-as-code-patterns-skill-2026`)
