# Robotics Ros2 Architecture Practice Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-ros2-architecture-practice-skill-2026`)
- Codex (`~/.codex/skills/robotics-ros2-architecture-practice-skill-2026`)
