# Mathematics Topological Data Insight Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-topological-data-insight-skill-2026`)
- Codex (`~/.codex/skills/mathematics-topological-data-insight-skill-2026`)
