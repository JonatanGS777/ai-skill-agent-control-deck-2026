...
- Claude Code (`~/.claude/skills/robotics-sensor-fusion-pipelines-skill-2026`)
- Codex (`~/.codex/skills/robotics-sensor-fusion-pipelines-skill-2026`)

## Purpose
Implementa practicas de robotica de alto nivel para sensor fusion pipelines con seguridad, precision y control verificable de extremo a extremo.
