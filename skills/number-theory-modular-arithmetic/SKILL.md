...
description: "Applies modular arithmetic and divisibility logic for correctness and crypto-adjacent tasks."
version: "1.0.0"
...
# Number Theory Modular Arithmetic Skill
...
## Example prompts
- "Apply the number-theory-modular-arithmetic skill to handle this task end-to-end."
- "Run number-theory-modular-arithmetic and produce a production-ready output with validation notes."
