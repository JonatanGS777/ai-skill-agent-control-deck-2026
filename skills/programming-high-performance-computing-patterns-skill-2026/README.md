...
- Claude Code (`~/.claude/skills/programming-high-performance-computing-patterns-skill-2026`)
- Codex (`~/.codex/skills/programming-high-performance-computing-patterns-skill-2026`)
