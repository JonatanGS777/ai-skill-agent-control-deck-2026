...
- Claude Code (`~/.claude/skills/ai-domain-ecommerce-conversion-intelligence-skill-2026`)
- Codex (`~/.codex/skills/ai-domain-ecommerce-conversion-intelligence-skill-2026`)
