...
- Claude Code (`~/.claude/skills/mathematics-measure-theory-for-engineers-skill-2026`)
- Codex (`~/.codex/skills/mathematics-measure-theory-for-engineers-skill-2026`)

## Purpose
Desarrolla soluciones matematicas avanzadas para measure theory for engineers con rigor formal, validacion reproducible y decisiones auditables.
