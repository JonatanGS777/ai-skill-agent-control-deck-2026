---
name: "relations-functions-foundations"
description: "Formalizes relations and functions with properties, mappings, and compositional reasoning."
version: "1.0.0"
...
## Example prompts
- "Apply the relations-functions-foundations skill to handle this task end-to-end."
- "Run relations-functions-foundations and produce a production-ready output with validation notes."
