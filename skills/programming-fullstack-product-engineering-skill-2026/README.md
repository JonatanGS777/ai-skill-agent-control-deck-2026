# Programming Fullstack Product Engineering Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-fullstack-product-engineering-skill-2026`)
- Codex (`~/.codex/skills/programming-fullstack-product-engineering-skill-2026`)
