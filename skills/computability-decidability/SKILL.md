...
description: "Evaluates what is computable, semi-decidable, or undecidable under formal models."
version: "1.0.0"
...
# Computability Decidability Skill
...
## Example prompts
- "Apply the computability-decidability skill to handle this task end-to-end."
- "Run computability-decidability and produce a production-ready output with validation notes."
