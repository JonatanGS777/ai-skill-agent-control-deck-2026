...
- Claude Code (`~/.claude/skills/mathematics-nonlinear-programming-analysis-skill-2026`)
- Codex (`~/.codex/skills/mathematics-nonlinear-programming-analysis-skill-2026`)
