...
- Claude Code (`~/.claude/skills/chatbot-persona-consistency-engine-skill-2026`)
- Codex (`~/.codex/skills/chatbot-persona-consistency-engine-skill-2026`)

## Purpose
Construye chatbots de alto rendimiento para persona consistency engine con dialogo robusto, guardrails claros y monitoreo continuo de calidad.
