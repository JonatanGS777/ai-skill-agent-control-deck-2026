...
- Claude Code (`~/.claude/skills/programming-microservices-resilience-patterns-skill-2026`)
- Codex (`~/.codex/skills/programming-microservices-resilience-patterns-skill-2026`)
