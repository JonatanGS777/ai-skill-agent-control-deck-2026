# Chatbot Realtime Chat Infrastructure Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/chatbot-realtime-chat-infrastructure-skill-2026`)
- Codex (`~/.codex/skills/chatbot-realtime-chat-infrastructure-skill-2026`)
