# Mathematics Numerical Method Stability Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-numerical-method-stability-skill-2026`)
- Codex (`~/.codex/skills/mathematics-numerical-method-stability-skill-2026`)
