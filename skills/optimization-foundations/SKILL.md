...
description: "Frames optimization problems with objective functions, constraints, and feasibility logic."
version: "1.0.0"
...
# Optimization Foundations Skill
...
## Example prompts
- "Apply the optimization-foundations skill to handle this task end-to-end."
- "Run optimization-foundations and produce a production-ready output with validation notes."
