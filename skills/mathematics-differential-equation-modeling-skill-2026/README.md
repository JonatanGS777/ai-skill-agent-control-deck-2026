# Mathematics Differential Equation Modeling Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-differential-equation-modeling-skill-2026`)
- Codex (`~/.codex/skills/mathematics-differential-equation-modeling-skill-2026`)
