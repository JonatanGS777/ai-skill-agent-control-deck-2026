---
name: "debugging-causal-reasoning-foundations"
description: "Uses causal reasoning to isolate root causes and avoid symptom-only fixes."
version: "1.0.0"
...
# Debugging Causal Reasoning Foundations Skill
...
## Example prompts
- "Apply the debugging-causal-reasoning-foundations skill to handle this task end-to-end."
- "Run debugging-causal-reasoning-foundations and produce a production-ready output with validation notes."
