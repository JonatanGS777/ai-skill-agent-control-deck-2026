---
name: "programming-refactoring-large-codebases-skill-2026"
description: "Aplica ingenieria de software moderna para refactoring large codebases con foco en robustez, mantenibilidad y excelencia operacional."
version: "1.0.0"
domain: "programming"
...
# Programming Refactoring Large Codebases Skill 2026 Skill

## Mission
Aplica ingenieria de software moderna para refactoring large codebases con foco en robustez, mantenibilidad y excelencia operacional.
...
## Example prompts
- "Apply the programming-refactoring-large-codebases-skill-2026 skill to handle this task end-to-end."
- "Run programming-refactoring-large-codebases-skill-2026 and produce a production-ready output with validation notes."
