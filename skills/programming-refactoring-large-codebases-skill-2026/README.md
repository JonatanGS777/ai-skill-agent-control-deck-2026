# Programming Refactoring Large Codebases Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-refactoring-large-codebases-skill-2026`)
- Codex (`~/.codex/skills/programming-refactoring-large-codebases-skill-2026`)
