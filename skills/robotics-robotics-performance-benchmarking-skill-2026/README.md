# Robotics Robotics Performance Benchmarking Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-robotics-performance-benchmarking-skill-2026`)
- Codex (`~/.codex/skills/robotics-robotics-performance-benchmarking-skill-2026`)
