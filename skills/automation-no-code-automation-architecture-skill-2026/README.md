...
- Claude Code (`~/.claude/skills/automation-no-code-automation-architecture-skill-2026`)
- Codex (`~/.codex/skills/automation-no-code-automation-architecture-skill-2026`)
