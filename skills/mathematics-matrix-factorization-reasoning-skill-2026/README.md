...
- Claude Code (`~/.claude/skills/mathematics-matrix-factorization-reasoning-skill-2026`)
- Codex (`~/.codex/skills/mathematics-matrix-factorization-reasoning-skill-2026`)
