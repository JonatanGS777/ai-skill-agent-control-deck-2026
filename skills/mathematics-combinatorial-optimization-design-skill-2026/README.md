...
- Claude Code (`~/.claude/skills/mathematics-combinatorial-optimization-design-skill-2026`)
- Codex (`~/.codex/skills/mathematics-combinatorial-optimization-design-skill-2026`)
