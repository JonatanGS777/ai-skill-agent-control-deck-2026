# Mathematics Geometric Computation Math Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-geometric-computation-math-skill-2026`)
- Codex (`~/.codex/skills/mathematics-geometric-computation-math-skill-2026`)
