# Chatbot Chatbot Analytics Pipeline Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/chatbot-chatbot-analytics-pipeline-skill-2026`)
- Codex (`~/.codex/skills/chatbot-chatbot-analytics-pipeline-skill-2026`)
