...
description: "Models uncertainty with probability axioms, conditional reasoning, and distribution checks."
version: "1.0.0"
...
## Example prompts
- "Apply the probability-foundations skill to handle this task end-to-end."
- "Run probability-foundations and produce a production-ready output with validation notes."
