---
name: "database-theory-normalization"
description: "Applies normalization, keys, dependencies, and integrity constraints to schema design."
version: "1.0.0"
...
# Database Theory Normalization Skill
...
## Example prompts
- "Apply the database-theory-normalization skill to handle this task end-to-end."
- "Run database-theory-normalization and produce a production-ready output with validation notes."
