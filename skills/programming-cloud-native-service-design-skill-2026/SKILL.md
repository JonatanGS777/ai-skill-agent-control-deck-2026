---
name: "programming-cloud-native-service-design-skill-2026"
description: "Aplica ingenieria de software moderna para cloud native service design con foco en robustez, mantenibilidad y excelencia operacional."
version: "1.0.0"
domain: "programming"
quality_tier: "expert"
compatibility:
...
# Programming Cloud Native Service Design Skill 2026 Skill

## Mission
Aplica ingenieria de software moderna para cloud native service design con foco en robustez, mantenibilidad y excelencia operacional.
...
## Example prompts
- "Apply the programming-cloud-native-service-design-skill-2026 skill to handle this task end-to-end."
- "Run programming-cloud-native-service-design-skill-2026 and produce a production-ready output with validation notes."
