...
- Claude Code (`~/.claude/skills/programming-algorithm-design-architectures-skill-2026`)
- Codex (`~/.codex/skills/programming-algorithm-design-architectures-skill-2026`)
