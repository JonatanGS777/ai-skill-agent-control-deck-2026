# Programming Testing Strategy At Scale Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-testing-strategy-at-scale-skill-2026`)
- Codex (`~/.codex/skills/programming-testing-strategy-at-scale-skill-2026`)
