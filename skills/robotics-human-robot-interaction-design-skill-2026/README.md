# Robotics Human Robot Interaction Design Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-human-robot-interaction-design-skill-2026`)
- Codex (`~/.codex/skills/robotics-human-robot-interaction-design-skill-2026`)
