# Programming Api Contract Governance Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-api-contract-governance-skill-2026`)
- Codex (`~/.codex/skills/programming-api-contract-governance-skill-2026`)
