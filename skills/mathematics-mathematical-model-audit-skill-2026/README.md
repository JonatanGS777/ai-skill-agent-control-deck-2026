# Mathematics Mathematical Model Audit Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-mathematical-model-audit-skill-2026`)
- Codex (`~/.codex/skills/mathematics-mathematical-model-audit-skill-2026`)
