# Chatbot Chatbot Ab Testing Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/chatbot-chatbot-ab-testing-skill-2026`)
- Codex (`~/.codex/skills/chatbot-chatbot-ab-testing-skill-2026`)
