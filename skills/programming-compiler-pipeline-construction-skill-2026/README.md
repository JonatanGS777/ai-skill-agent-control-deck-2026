...
- Claude Code (`~/.claude/skills/programming-compiler-pipeline-construction-skill-2026`)
- Codex (`~/.codex/skills/programming-compiler-pipeline-construction-skill-2026`)
