---
name: "testing-verification-foundations"
description: "Combines testing strategy and formal verification checks for dependable systems."
version: "1.0.0"
...
# Testing Verification Foundations Skill
...
## Example prompts
- "Apply the testing-verification-foundations skill to handle this task end-to-end."
- "Run testing-verification-foundations and produce a production-ready output with validation notes."
