---
name: "concurrency-memory-model-foundations"
description: "Reasons about concurrency using ordering, visibility, and memory-model constraints."
version: "1.0.0"
...
# Concurrency Memory Model Foundations Skill
...
## Example prompts
- "Apply the concurrency-memory-model-foundations skill to handle this task end-to-end."
- "Run concurrency-memory-model-foundations and produce a production-ready output with validation notes."
