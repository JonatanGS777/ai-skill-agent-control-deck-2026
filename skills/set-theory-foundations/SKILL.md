---
name: "set-theory-foundations"
description: "Models problems with sets, subsets, unions, intersections, and cardinal reasoning."
version: "1.0.0"
...
## Example prompts
- "Apply the set-theory-foundations skill to handle this task end-to-end."
- "Run set-theory-foundations and produce a production-ready output with validation notes."
