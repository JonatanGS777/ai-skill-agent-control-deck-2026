...
- Claude Code (`~/.claude/skills/ai-domain-manufacturing-quality-intelligence-skill-2026`)
- Codex (`~/.codex/skills/ai-domain-manufacturing-quality-intelligence-skill-2026`)
