...
- Claude Code (`~/.claude/skills/automation-api-integration-automation-skill-2026`)
- Codex (`~/.codex/skills/automation-api-integration-automation-skill-2026`)

## Purpose
Disena procesos automatizados para api integration automation con control logico, trazabilidad completa y validacion operativa de extremo a extremo.
