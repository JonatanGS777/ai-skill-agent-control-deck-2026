# Mathematics Category Theory Programming Bridge Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-category-theory-programming-bridge-skill-2026`)
- Codex (`~/.codex/skills/mathematics-category-theory-programming-bridge-skill-2026`)
