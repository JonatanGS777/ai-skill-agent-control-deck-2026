# Mathematics Signal Processing Mathematics Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-signal-processing-mathematics-skill-2026`)
- Codex (`~/.codex/skills/mathematics-signal-processing-mathematics-skill-2026`)
