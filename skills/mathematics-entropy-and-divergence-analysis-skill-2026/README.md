...
- Claude Code (`~/.claude/skills/mathematics-entropy-and-divergence-analysis-skill-2026`)
- Codex (`~/.codex/skills/mathematics-entropy-and-divergence-analysis-skill-2026`)
