...
- Claude Code (`~/.claude/skills/programming-continuous-delivery-architecture-skill-2026`)
- Codex (`~/.codex/skills/programming-continuous-delivery-architecture-skill-2026`)
