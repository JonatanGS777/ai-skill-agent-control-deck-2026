# Mathematics Formal Verification Mathematics Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/mathematics-formal-verification-mathematics-skill-2026`)
- Codex (`~/.codex/skills/mathematics-formal-verification-mathematics-skill-2026`)
