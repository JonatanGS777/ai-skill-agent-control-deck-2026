...
- Claude Code (`~/.claude/skills/programming-database-system-design-skill-2026`)
- Codex (`~/.codex/skills/programming-database-system-design-skill-2026`)

## Purpose
Aplica ingenieria de software moderna para database system design con foco en robustez, mantenibilidad y excelencia operacional.
