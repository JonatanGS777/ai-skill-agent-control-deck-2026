...
- Claude Code (`~/.claude/skills/programming-observability-driven-debugging-skill-2026`)
- Codex (`~/.codex/skills/programming-observability-driven-debugging-skill-2026`)
