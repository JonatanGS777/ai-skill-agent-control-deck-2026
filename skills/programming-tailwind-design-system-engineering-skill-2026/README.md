# Programming Tailwind Design System Engineering Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-tailwind-design-system-engineering-skill-2026`)
- Codex (`~/.codex/skills/programming-tailwind-design-system-engineering-skill-2026`)
