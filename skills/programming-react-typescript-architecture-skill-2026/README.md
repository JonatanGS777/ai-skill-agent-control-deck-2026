# Programming React Typescript Architecture Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/programming-react-typescript-architecture-skill-2026`)
- Codex (`~/.codex/skills/programming-react-typescript-architecture-skill-2026`)
