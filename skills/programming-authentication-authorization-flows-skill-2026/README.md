...
- Claude Code (`~/.claude/skills/programming-authentication-authorization-flows-skill-2026`)
- Codex (`~/.codex/skills/programming-authentication-authorization-flows-skill-2026`)
