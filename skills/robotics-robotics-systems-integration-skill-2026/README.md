# Robotics Robotics Systems Integration Skill 2026

This folder contains a universal skill designed to work in both:

- Claude Code (`~/.claude/skills/robotics-robotics-systems-integration-skill-2026`)
- Codex (`~/.codex/skills/robotics-robotics-systems-integration-skill-2026`)
